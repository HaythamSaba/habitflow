...
export function CreateHabitModal({ isOpen, onClose }: CreateHabitModalProps) {
  ...
  const createHabit = useCreateHabit(); // ⭐ Use mutation hook
      ...
      <form className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <label className="relative flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-primary transition-colors">
              <input
                type="radio"
                value="daily"
                {...register("frequency")}
