      ...
      <div className="w-full">
        ...
        <div className="relative">
          <input
            ...
            className={cn(
              "input w-full px-3 sm:px-4 py-2 sm:py-2.5 min-h-11 rounded-lg border border-gray-300 dark:border-gray-700",
              "bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 text-sm sm:text-base placeholder:text-gray-400 dark:placeholder:text-gray-500",
